"""
aeon/sensors/processor.py — Sensor data validation and enrichment.

Receives FeatureFrames from the serial bridge, validates their ranges,
computes any additional derived metrics, stores them, and publishes
them to the WebSocket bus for the real-time dashboard.
"""
