...
class Checkpoint:
    ...
    # Whether the model is allowed to act on its own. Persisted deliberately: a
    # house where someone switched the automation off must not quietly start
    # actuating again because the node rebooted. Consent survives a power cut.
