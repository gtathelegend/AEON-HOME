...
class LeafDevice:
    ...
    async def stop(self) -> None:
        ...
        Drop those sockets BEFORE awaiting wait_closed(). Since Python 3.12.1 it
        waits for every live handler to return, so unplugging a leaf while the
        node still holds the link would otherwise block here forever.
        """
