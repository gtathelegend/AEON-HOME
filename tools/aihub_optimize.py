...
CPU inference through ONNX Runtime -- fine for 6,850 parameters, but CPU. Profile
...
from aeon import aihub, devices, tsmodel      # noqa: E402
...
def main() -> int:
    ...
    import numpy as np
    sample = np.zeros((1, 105), dtype=np.float32)
