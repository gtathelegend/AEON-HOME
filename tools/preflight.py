...
def check_onnx_runtime() -> None:
    ...
    if "QNNExecutionProvider" in providers:
        ...
        line("note", "no QNN. Inference runs on CPU, which is fine at 6,850 params.")
...
def check_model_roundtrip() -> None:
    ...
    try:
        ...
        bench = runner.benchmark(np.zeros((1, 105), dtype=np.float32), iterations=100)
