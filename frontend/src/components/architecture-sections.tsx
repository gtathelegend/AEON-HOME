...
export function HardwareConnectionPanel() {
  ...
  const arduinoPins: BoardCardPin[] = [
    ...
    { pin: "D7", signal: "Relay 1 (Primary)", value: serial.connected ? "Inactive" : "—", status: serial.connected ? "warning" : "error" },
    { pin: "D8", signal: "Relay 2 (Secondary)", value: serial.connected ? "Inactive" : "—", status: serial.connected ? "warning" : "error" },
